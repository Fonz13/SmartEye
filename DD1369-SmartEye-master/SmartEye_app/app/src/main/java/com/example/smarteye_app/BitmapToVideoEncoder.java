...
public class BitmapToVideoEncoder {
    ...
    private static final int BIT_RATE = 16000000; //16000000 HD //6000000 ok //2000000 ait
    ...
    public void startEncoding(int width, int height, File outputFile, WeakHandler handler) {
        doneFrames = 0;
        mHandler = handler;
        mWidth = width;
        mHeight = height;
        ...
        try {
            ...
            //Our videos were rotated, this solves it
    ...
    private void encode() {
        ...
        while(true) {
            ...
            ///Uppdaterar UI från tråd
            Log.i("VideoTest", "BitmapToEncoder 1");
    ...
    private void release() {
        ...
        Log.e(TAG, "WRITING FILE TO MP4 IS DONE!!!!!!!!!!!!!!!!!!!!! " );
    }
